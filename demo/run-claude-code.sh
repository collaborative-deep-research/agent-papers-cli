...
dim "  [r3] Test-Time Training Done Right — Zhang et al., 2025"
dim "  ..."
echo ""
sleep 1.2
...
echo -e "    ${GREEN}[s3]${RESET} TTT Done Right: LaCT (Zhang et al., 2025)"
...
echo ""
sleep 0.3
echo -e "    ${GREEN}[1]${RESET} E2E TTT: End-to-End Test Time Training (2025)"
echo -e "        ${DIM}arXiv:2512.23675${RESET}"
echo -e "    ${GREEN}[2]${RESET} TTT Done Right (Zhang et al., 2025)"
...
echo -e "     hidden state."
echo ""
echo -e "  ${BOLD}3. TTT Done Right / LaCT (Zhang et al., 2025)${RESET}"
